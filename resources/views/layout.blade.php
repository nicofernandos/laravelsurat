...
<head>
    <meta charset="utf-8">
    <title>Surat Laravel</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="" name="keywords">
    <meta content="" name="description">

    <!-- Favicon -->
    <link href="{{ asset('foto/logoe.jpg') }}" rel="icon">
...
<body>
    ...
    <div class="container-fluid fixed-atas px-0 wow fadeIn" data-wow-delay="0.1s">
        <div class="bg-dark py-3">
            <center>
                <img src="{{ asset('foto/logoe.jpg') }}" width="50px">
            </center>
        </div>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-12 col-md-12">
                    <h4 class="text-white mb-4">Biro Administrasi Pembangunan Sekretariat Daerah Provinsi Sumatera
                        Selatan</h4>
                    <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Jl. xxxx. No. xxx, Kota xxx
                    </p>
                    <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>08xx-xxxx-xxxx</p>
